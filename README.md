...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/importrosbag-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13003&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/importrosbag-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `importrosbag` can be installed with:

```
conda install importrosbag
```

It is possible to list all of the versions of `importrosbag` available on your platform with:
